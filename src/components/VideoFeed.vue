...
<template>
  <div class="video-feed">
    ...
    <div class="video-feed__screen">
      <video class="video-feed__video" :src="mode === 'visible' ? videoSrc : infraredSrc" autoplay loop muted playsinline />
      <!-- 暗角遮罩 -->
...
.video-feed__screen { flex: 1; position: relative; background: linear-gradient(135deg, #1a2538, #355278); }
